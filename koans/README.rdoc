...
Some, however, require_relative you to supply your own answer.  If you see the method +__+ (a
...
require_relatives       :: Ruby 1.8.x or later and Rake (any recent version)
