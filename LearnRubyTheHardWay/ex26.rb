...
Ex26.print_first_and_last_sorted(sentence)
 ...
 # What I learned
 # This was pretty easy. Hopefully that shows I have been learning!
 # I probably did 90% of the fixes before running it, then the remaining ones were mostly when the wrong variable name was used, as opposed to typos
